:Title: Geospatial API for Features - Part 2: Coordinate Reference Systems by Reference
:titletext: Geospatial API - Features - Part 2: Coordinate Reference Systems by Reference
:doctype: book
:encoding: utf-8
:lang: en
:toc:
...
|External identifier of this OGC(R) document: http://www.opengis.net/doc/IS/ogcapi-features-2/1.0
|Internal reference number of this OGC(R) document:    18-058r2
|Version: link:http://docs.opengeospatial.org/DRAFTS/18-058r2.html[1.0.2-SNAPSHOT (Editor's draft)]
|Latest Published Version: https://docs.opengeospatial.org/is/18-058r1/18-058r1.html[1.0.1]
...
include::clause_6_crs.adoc[]

////
include::clause_7_media_types.adoc[]

include::clause_8_security_considerations.adoc[]
////
